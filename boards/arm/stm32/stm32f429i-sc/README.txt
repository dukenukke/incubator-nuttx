...
STMicro STM32F429I-SeriousControls development board featuring the STM32F429IGT6
MCU. The STM32F429IGT6 is a 180MHz Cortex-M4 operation with 1Mbit Flash
memory and 256kbytes. The board features:

  - On-board 256 Mbits (32 Mbytes) External SDRAM (4 Mbit x 16-bit x 4-bank)
  - TFT 7" LCD, 262K color RGB, 800 x 480 pixels
  - Touchscreen controller
  - One user LEDs and one push-button,
  - USB OTG FS with micro-AB connector, and
  - Easy access to most MCU pins.

NOTE:  Includes basic NSH command support with full 32MByte SDRAM + the
...
board (search keyword: 429i-SC)

Interfaces:
SPI4          - ADS7843E touchscreen interface
I2C2          - BME280, STM8S i2c interface
TIM3 CH4  PWM - sound
TIM8 CH3N PWM - LCD backlight
LTDC - LCD interface
USART2 - ESP8266 WiFi interface
USART3 - RS485
USART6 - MH-Z19 CO2 sensor
SDIO   - SD card
...
========
  ...
  - FPU
  - FMC SDRAM
  - STM32F429I-SC-specific Configuration Options
  - Configurations

Development Environment
=======================

The Development environments for the STM32F429I-SC board are identical
...
boards/arm/stm32/stm32f4sc directory.
...
The STM32F429I-SC board has 1 user LED; green, and red on the board.
