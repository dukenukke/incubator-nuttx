...
STM32F429I-SC LTDC Framebuffer demo example

Configure and build
-------------------

cd tools
./configure -a <appdir> stm32f429i-sc/fb
cd ..
make
...
Use the helper script boards/stm32f429i-sc/tools/fbcalc.sh for calculating
